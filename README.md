...
- подавление кратковременных сбоев, тихие часы, повтор доставки и ежедневная Telegram-сводка;
- графики доступности за 30 минут, 24 часа и 7 дней, экспорт событий CSV/JSON;
- системные PWA-уведомления при открытом приложении и расширенная диагностика Telegram/UniFi;
